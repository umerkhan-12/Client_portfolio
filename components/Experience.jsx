...
//               whileTap={{ scale: 0.95 }}
//               className="px-6 py-3 bg-violet-600 text-white rounded-full shadow hover:bg-violet-700 transition"
//             >
        ...
        <div className="mt-10 text-center">
          <Link href="/experience">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className={`${montserrat.className} px-6 py-3 bg-violet-600 text-white rounded-full shadow hover:bg-violet-700 transition`}
            >
              View Full Experience →
            </motion.button>
          </Link>
